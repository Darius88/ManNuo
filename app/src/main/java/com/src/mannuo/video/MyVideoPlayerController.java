...
public class MyVideoPlayerController extends NiceVideoPlayerController implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, ChangeClarityDialog.OnClarityChangedListener {
    ...
    private BroadcastReceiver mBatterReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if(status == 2) {
                MyVideoPlayerController.this.mBattery.setImageResource(com.xiao.nicevideoplayer.R.drawable.battery_charging);
            } else if(status == 5) {
                MyVideoPlayerController.this.mBattery.setImageResource(com.xiao.nicevideoplayer.R.drawable.battery_full);
            } else {
                int level = intent.getIntExtra("level", 0);
                int scale = intent.getIntExtra("scale", 0);
                int percentage = (int)((float)level / (float)scale * 100.0F);
                if(percentage <= 10) {
                    MyVideoPlayerController.this.mBattery.setImageResource(com.xiao.nicevideoplayer.R.drawable.battery_10);
                } else if(percentage <= 20) {
                    MyVideoPlayerController.this.mBattery.setImageResource(com.xiao.nicevideoplayer.R.drawable.battery_20);
                } else if(percentage <= 50) {
                    MyVideoPlayerController.this.mBattery.setImageResource(com.xiao.nicevideoplayer.R.drawable.battery_50);
                } else if(percentage <= 80) {
                    MyVideoPlayerController.this.mBattery.setImageResource(com.xiao.nicevideoplayer.R.drawable.battery_80);
                } else if(percentage <= 100) {
                    MyVideoPlayerController.this.mBattery.setImageResource(com.xiao.nicevideoplayer.R.drawable.battery_100);
                }
            }
    ...
    private void init() {
        LayoutInflater.from(this.mContext).inflate(com.xiao.nicevideoplayer.R.layout.tx_video_palyer_controller, this, true);
